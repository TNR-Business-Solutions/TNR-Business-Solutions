...
class AutoDeployAll {
  ...
  generateServicePagesContent() {
    ...
    this.log(`✅ Generated content for ${servicesData.length} service pages`, 'success');
  }
  ...
  generateStructuredData() {
    ...
    const structuredData = {
      ...
      localBusiness: {
        ...
        "@type": "LocalBusiness",
        "name": "TNR Business Solutions",
        "description": "Leading digital marketing agency and insurance services in Greensburg PA",
        "url": "https://www.tnrbusinesssolutions.com",
        "telephone": "+1-412-499-2987",
        "email": "Info@TNRBusinessSolutions.com",
        "address": {
...
`;
  ...
  async commitAndPush() {
    try {
      ...
      execSync(`git commit -m "🚀 Automated Wix Deployment - ${timestamp}"`, { stdio: 'inherit' });
  ...
  async deployAll() {
    try {
      ...
      if (gitSuccess) {
        ...
        this.log('🌐 Your website content has been generated and pushed to GitHub!', 'success');
        this.log('🔄 GitHub Actions will now run automatically to update your Wix site', 'info');
        ...
        this.log('📁 You can manually copy content from the wix-deployment folder', 'info');
        return false;
      }
    } catch (error) {
